...
const PRODUCTS = {
  ...
  13:['Nutella Banana Nuts',500000,'Crepetna','76 656 367'], 14:['Nutella Lotus',500000,'Crepetna','76 656 367'],
  15:['Nutella Kinder Bueno',550000,'Crepetna','76 656 367'], 16:['Brownies',450000,'Orianne','79 306 256'],
  17:['Merry Cream',200000,'Marcelino Mikhael','71 540 832'],
  18:['Limonade',200000,'Elie Lteif (Frisco)','03 502 849'],
  19:['Soft Drink',50000,'Akhawiyat','03 773 860'], 20:['Water Small',10000,'Akhawiyat','03 773 860'],
  21:['Ice Tea',60000,'Akhawiyat','03 773 860'], 22:['Beer',75000,'Akhawiyat','03 773 860'],
  23:['Beer Rosée',75000,'Akhawiyat','03 773 860'], 24:['Carbonated Beer',50000,'Akhawiyat','03 773 860'],
  25:['XXL',195000,'Akhawiyat','03 773 860'], 26:['Arguile',500000,'Hammoura','81 067 970'],
  27:['Cotton Candy',100000,'Joceline','03 773 860'], 28:['Bzourat',25000,'Akhawiyat','03 773 860'],
